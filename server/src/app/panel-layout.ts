...
export class PanelLayoutManager implements AppModule {
      ...
      <div class="header">
        ...
        <div class="header-center">
          <div class="header-center-panel">
            <div class="header-center-label">THEATER</div>
          ...
          <div class="header-signal-strip">
            <span class="header-signal-dot"></span>
            <span class="header-signal-text">LIVE OSINT GRID</span>
          </div>
        </div>
  ...
  private createPanels(): void {
    ...
    if (SITE_VARIANT === 'full') {
      ...
      const geoLocatePanel = new GeoLocatePanel(this.ctx.map);
      this.ctx.panels['geo-filters'] = geoLocatePanel;
