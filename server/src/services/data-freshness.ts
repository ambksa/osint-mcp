...
export type DataSourceId =
  ...
  | 'polymarket_intel' // Polymarket intel addon
  ...
  | 'construction';        // Construction site activity (OSM)
...
const SOURCE_METADATA: Record<DataSourceId, { name: string; requiredForRisk: boolean; panelId?: string }> = {
  ...
  polymarket_intel: { name: 'Polymarket Intel', requiredForRisk: false, panelId: 'polymarket-intel' },
  ...
  construction: { name: 'Construction Activity (OSM)', requiredForRisk: false, panelId: 'map' },
};
...
const INTELLIGENCE_GAP_MESSAGES: Record<DataSourceId, string> = {
  ...
  polymarket_intel: 'Polymarket intel feed unavailable—market depth and trade signals may be stale',
