...
export const LAYER_PRESETS: Record<string, (keyof MapLayers)[]> = {
  ...
  infra: ['cables', 'pipelines', 'datacenters', 'spaceports', 'minerals', 'construction'],
...
export const COMMANDS: Command[] = [
  ...
  { id: 'layer:construction', keywords: ['construction', 'build', 'building', 'infrastructure works'], label: 'Toggle construction activity', icon: '\u{1F3D7}\uFE0F', category: 'layers' },
  { id: 'layer:geoFilters', keywords: ['geo filters', 'geolocate', 'bellingcat', 'osm', 'street signs'], label: 'Toggle geo filters', icon: '\u{1F50D}', category: 'layers' },
  ...
  { id: 'layer:satellite', keywords: ['satellite', 'satellite imagery', 'imagery', 'gibs'], label: 'Toggle satellite imagery', icon: '\u{1F6F0}\uFE0F', category: 'layers' },
